//===-- ShaktiMCAsmInfo.cpp - Shakti asm properties ------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains the declarations of the ShaktiMCAsmInfo properties.
//
//===----------------------------------------------------------------------===//
...
void ShaktiMCAsmInfo::anchor() {}

ShaktiMCAsmInfo::ShaktiMCAsmInfo(const Triple &TT) {
  IsLittleEndian = true;
