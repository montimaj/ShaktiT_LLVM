//===-- ShaktiISelLowering.h - Shakti DAG Lowering Interface -----*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that Shakti uses to lower LLVM code into
// a selection DAG.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_SHAKTI_SHAKTIISELLOWERING_H
#define LLVM_LIB_TARGET_SHAKTI_SHAKTIISELLOWERING_H
...
class ShaktiTargetLowering : public TargetLowering {
public:
  explicit ShaktiTargetLowering(const TargetMachine &TM,
...
private:
  ...
  const ShaktiSubtarget &Subtarget;
};
} // namespace llvm

#endif // SHAKTI_ISELLOWERING_H
