...
static Value *EmitTargetArchBuiltinExpr(CodeGenFunction *CGF,
  ...
  case llvm::Triple::shakti:
    return CGF->EmitShaktiBuiltinExpr(BuiltinID, E);
  default:
    return nullptr;
  }
}
...
Value *CodeGenFunction::EmitShaktiBuiltinExpr(unsigned BuiltinID,
                                             const CallExpr *E) {
  ...
  switch (BuiltinID) {
    case Shakti::BI__builtin_shakti_read_control_reg:
      F = CGM.getIntrinsic(Intrinsic::shakti_read_control_reg);
      break;
    case Shakti::BI__builtin_shakti_write_control_reg:
      F = CGM.getIntrinsic(Intrinsic::shakti_write_control_reg);
      break;
    case Shakti::BI__builtin_shakti_shufflei:
      F = CGM.getIntrinsic(Intrinsic::shakti_shufflei);
      break;
    case Shakti::BI__builtin_shakti_shufflef:
      F = CGM.getIntrinsic(Intrinsic::shakti_shufflef);
      break;
    case Shakti::BI__builtin_shakti_gather_loadi:
      F = CGM.getIntrinsic(Intrinsic::shakti_gather_loadi);
      break;
    case Shakti::BI__builtin_shakti_gather_loadf:
      F = CGM.getIntrinsic(Intrinsic::shakti_gather_loadf);
      break;
    case Shakti::BI__builtin_shakti_scatter_storei:
      F = CGM.getIntrinsic(Intrinsic::shakti_scatter_storei);
      break;
    case Shakti::BI__builtin_shakti_scatter_storef:
      F = CGM.getIntrinsic(Intrinsic::shakti_scatter_storef);
      break;
  }
  ...
  // XXX These shakti types should be replaced by existing LLVM intrinsics.
  SmallVector<Value*, 2> MemOps;
  MemOps.push_back(EmitScalarExpr(E->getArg(0)));
  switch (BuiltinID) {
    // (vec16_t ptrs, int mask)
    case Shakti::BI__builtin_shakti_gather_loadi_masked:
      F = CGM.getIntrinsic(Intrinsic::shakti_gather_loadi_masked);
      MemOps.push_back(Int16ToMask(Builder, EmitScalarExpr(E->getArg(1))));
      break;
    case Shakti::BI__builtin_shakti_gather_loadf_masked:
      F = CGM.getIntrinsic(Intrinsic::shakti_gather_loadf_masked);
      MemOps.push_back(Int16ToMask(Builder, EmitScalarExpr(E->getArg(1))));
      break;
    ...
    case Shakti::BI__builtin_shakti_scatter_storei_masked:
      F = CGM.getIntrinsic(Intrinsic::shakti_scatter_storei_masked);
      MemOps.push_back(EmitScalarExpr(E->getArg(1)));
      MemOps.push_back(Int16ToMask(Builder, EmitScalarExpr(E->getArg(2))));
      break;
    case Shakti::BI__builtin_shakti_scatter_storef_masked:
      F = CGM.getIntrinsic(Intrinsic::shakti_scatter_storef_masked);
      MemOps.push_back(EmitScalarExpr(E->getArg(1)));
      MemOps.push_back(Int16ToMask(Builder, EmitScalarExpr(E->getArg(2))));
      break;

    // (vec16_t *ptr, vec16_t values, int mask)
    case Shakti::BI__builtin_shakti_block_storei_masked:
      F = CGM.getIntrinsic(Intrinsic::shakti_block_storei_masked);
      MemOps.push_back(EmitScalarExpr(E->getArg(1)));
      MemOps.push_back(Int16ToMask(Builder, EmitScalarExpr(E->getArg(2))));
      break;
    case Shakti::BI__builtin_shakti_block_storef_masked:
      F = CGM.getIntrinsic(Intrinsic::shakti_block_storef_masked);
      MemOps.push_back(EmitScalarExpr(E->getArg(1)));
      MemOps.push_back(Int16ToMask(Builder, EmitScalarExpr(E->getArg(2))));
      break;
